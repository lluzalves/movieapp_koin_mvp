package com.app.daniel.app.movieapp.movies.toprated
...
class TopMoviesFragment : BaseFragment<MoviesContract.MoviePresenter>(), MoviesContract.MoviesView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        app_name.text = getString(R.string.top_rated_movies)
        onStartView()
    }

    override fun onStartView() {
        presenter.fetchPopularMovies(page,MovieRequestType.TOP_RATED)
    }
