...
val applicationModule = module(override = true) {
    ...
    factory<MoviesContract.MoviePresenter> { (view: MoviesContract.MoviesView) -> MoviesPresenter(view) }
    factory<MovieDetailsContract.MovieDetailsPresenter> { (view: MovieDetailsContract.MovieDetailsView) -> MovieDetailsPresenter(view) }
